...
alias sshpreprod="sshpass -f ~/.pwpreprod ssh preprod"
alias sshpreprodnew="ssh preprod-new"
alias sshlive="sshpass -f ~/.pwlive ssh live"
alias sshlivedb="sshpass -f ~/.pwlive ssh live-db"
