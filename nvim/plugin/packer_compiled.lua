...
_G.packer_plugins = {
  ...
  ["aerial.nvim"] = {
    ...
    loaded = true,
    path = "/Users/georgeviolaris/.local/share/nvim/site/pack/packer/start/aerial.nvim",
  ...
  ["neo-tree.nvim"] = {
    loaded = true,
    path = "/Users/georgeviolaris/.local/share/nvim/site/pack/packer/start/neo-tree.nvim",
